            ...
            <div class="form-group">
                ...
                <select class="form-control" name="categoryid" id="categoryid">
                    ...
                    @foreach($categories as $category)
                        <option value="{{ $category->categoryid }}" @if(old('categoryid') === $category->categoryid) selected @endif>{{ $category->title }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                ...
                <select class="form-control" name="feedsourceid" id="feedsourceid">
                    ...
                    @foreach($feedsources as $feedsource)
                        <option value="{{ $feedsource->feedsourceid }}" @if(old('feedsourceid') === $feedsource->feedsourceid) selected @endif>{{ $feedsource->sourcename }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
